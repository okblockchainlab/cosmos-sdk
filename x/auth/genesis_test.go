...
const (
	defaultGenExportExpected       = `{"params":{"max_memo_characters":"256","tx_sig_limit":"7","tx_size_cost_per_byte":"10","sig_verify_cost_ed25519":"590","sig_verify_cost_secp256k1":"1000"},"accounts":null}`
...
var (
	genExportExpected = fmt.Sprintf(`{"params":{"max_memo_characters":"%d","tx_sig_limit":"%d","tx_size_cost_per_byte":"%d","sig_verify_cost_ed25519":"%d","sig_verify_cost_secp256k1":"%d"},"accounts":null}`,
...
func TestInitGenesis(t *testing.T) {
	...
	appModule := NewAppModule(input.appCodec, accKeeper)
	...
	newAppModule := NewAppModule(input.appCodec, newAccKeeper)
